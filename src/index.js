...
import { modal, modalIndex, modalPJ, modalIndexPJ } from './reducers/modal'; 
...
const reducers = combineReducers({data,notify,empresa,modal,modalIndex,modalPJ,modalIndexPJ});
